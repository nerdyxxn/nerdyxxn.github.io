    ...
    <main>
        <div id="contaniner">
            <div class="main_section1">
                ...
                <div class="logo">
                    <a href="index.jsp"><img src="img/logo.png" alt="IPU" /></a>
                </div>
                <div class="toggle">
            ...
            <div class="main_section2">
                                ...
                                <li class="submenuLi">
                                    ...
                                    <div id="myProgress">
                                        <ul class="progress_point">
                                            <li id="startPoint"></li>
                                            <li id="startToHalfPoint"></li>
                                            <li id="halfPoint"></li>
                                            <li id="halfToEndPoint"></li>
                                            <li id="endPoint"></li>
                                        </ul>
                                        <div id="myBar"></div>
                                    </div>
                ...
                <div class="userSendSOS">
                    <button class="callGuard" onclick="">
                        <img src="img/icon/ico_siren.png">
                    </button>
                    <div class="guardItems">
                        <button class="guardSqure" id="guard01" onclick="location.href='tel:02-1234-5678'">
                            <div class="guardSqureTitle">Call</div>
                            <div class="guardSqureName">엄마</div>
                        </button>
                        <button class="guardSqure" id="guard02" onclick="location.href='tel:02-1234-5678'">
                            <div class="guardSqureTitle">Call</div>
                            <div class="guardSqureName">아빠</div>
                        </button>
                        <button class="guardSqure" id="guard03" onclick="location.href='tel:02-1234-5678'">
                            <div class="guardSqureTitle">Call</div>
                            <div class="guardSqureName">언니</div>
                        </button>
                        <button class="guardSqure" id="guard04" onclick="location.href='tel:02-1234-5678'">
                            <div class="guardSqureTitle">Call</div>
                            <div class="guardSqureName">엄마</div>
                        </button>
                        <button class="guardSqure" id="guard05" onclick="location.href='tel:02-1234-5678'">
                            <div class="guardSqureTitle">Call</div>
